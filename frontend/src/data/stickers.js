...
export const STICKERS = [
  ...
  { id: 'fit_charlie_grad',       name: 'Grad Charlie',        category: 'outfits', icon: 'assets/characters/charlie-grad.png',        color: '#2C3E50', hint: 'Beat Stu Kazoo Says level 8' },
  ...
  { id: 'ach_simon_5',       name: 'Super Ear',          category: 'achievements', icon: 'assets/characters/dr-jellybone.png',     color: '#4285F4', hint: 'Beat level 5 in Stu Kazoo Says' },
